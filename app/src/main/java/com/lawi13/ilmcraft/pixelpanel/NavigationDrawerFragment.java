...
public class NavigationDrawerFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mCurrentSelectedGroup = savedInstanceState.getInt(STATE_SELECTED_GROUP_POSITION);
            mCurrentSelectedChild = savedInstanceState.getInt(STATE_SELECTED_CHILD_POSITION);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mFragmentContainerView = inflater.inflate(R.layout.fragment_navigation_drawer,
                container, false);
    ...
    private void prepareListData() {
        ...
        for (int i = 0; i < groupArray.length; i++) {
            ...
            if (ids[i] > 0) {
                String[] childArray = getResources().getStringArray(ids[i]);
                //hier ist java mega dreckig... zum Glueck sammelt jemand den muell...
                childList = new ArrayList<String>();
                for (String child : childArray) {
                    childList.add(child);
                }
                listDataChild.put(group, childList);
            } else {
                Toast toast = Toast.makeText(getActivity(), "No resource ID String found for: " + group, Toast.LENGTH_LONG);
                toast.show();
            }
        }
    }
    ...
    private void selectItem(int group, int child) {
        if (lv != null) {
            lv.setItemChecked(mCurrentSelectedGroup, false);
            lv.setItemChecked(mCurrentSelectedChild, false);
            mCurrentSelectedGroup = group;
            mCurrentSelectedChild = child;
            lv.setItemChecked(group, true);
            lv.setItemChecked(child, true);
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt(STATE_SELECTED_GROUP_POSITION, mCurrentSelectedGroup);
        outState.putInt(STATE_SELECTED_CHILD_POSITION, mCurrentSelectedChild);
    }
