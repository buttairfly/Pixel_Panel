...
public class HSVColorPickerDialog extends AlertDialog {
	...
	public interface OnColorSelectedListener {
		 ...
		 * possible if {@link com.lawi13.ilmcraft.pixelpanel.HSVColorPickerDialog#setNoColorButton(int) setNoColorButton()}
	 ...
	 * which will call the listener's {@link com.lawi13.ilmcraft.pixelpanel.HSVColorPickerDialog.OnColorSelectedListener#colorSelected(Integer) colorSelected(Integer)} callback
